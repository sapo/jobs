    ...
    <div class="block">
        ...
        >
            <template #content>
                ...
                <p>
                    The server is expected to return the params name and X-Token sent by the http request in json format.
                </p>
            </template>
        </CustomBlock>
